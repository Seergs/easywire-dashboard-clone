...
const Header = () => {
  return (
    <header className="bg-white h-32 px-12 lg:px-24 xl:px-32 shadow-sm border-b">
      ...
      <div className="h-20 flex items-center justify-between">
        <div className="flex">
          <div className="hidden xl:block  h-12 w-12 rounded-full overflow-hidden mr-5">
            <img
              src="/assets/images/avatar.jpg"
              alt="girl avatar"
          ...
          <div>
            <h2 className="font-bold xl:text-xl md:text-lg">
            ...
            <div className="flex mt-1">
              ...
              <div className="flex items-center ml-2 lg:ml-5 text-gray-600 text-sm font-medium">
